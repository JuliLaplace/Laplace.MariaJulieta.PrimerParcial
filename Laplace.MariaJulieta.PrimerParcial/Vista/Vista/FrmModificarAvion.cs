...
namespace Vista
{
    public partial class FrmModificarAvion : FrmAgregarAvion
    {
        ...
        protected override void btnBoton1_Click(object sender, EventArgs e)
        {
                ...
                Empresa.ModificarAvion(avionRecibido, (EAvion)this.cboAviones.SelectedValue, Convert.ToInt32(this.domUpDownAsientos.SelectedItem), Convert.ToInt32(this.domUpDownCantidadBanios.SelectedItem), Convert.ToSingle(this.domUpDownCapacidadMaxima.SelectedItem));
